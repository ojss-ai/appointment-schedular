...
/**
 * Consumer-side deduplication record (NFR-2.1) — same shared
 * {@code processed_events} table (V013) as notification-service, scoped by
 * consumer group {@code audit-consumers}.
 */
@Entity
