...
|---|---|---|---|---|---|
| P1-T01 | 1 | Monorepo scaffold — pnpm workspace, Turborepo, Docker Compose | P0 | 1d | [INFRA] |
| P1-T02 | 1 | Claude Code agent configuration (`.claude/` setup) | P0 | 0.5d | [ORCHESTRATION] |
| P1-T03 | 1 | Local dev infrastructure — PostgreSQL, Kafka, Redis, Schema Registry | P0 | 1d | [INFRA] |
| P1-T04 | 1 | Core Flyway migrations V001–V009 (tenants → operating_matrix) | P0 | 1.5d | [MIGRATION] |
| P1-T05 | 1 | Spring Security — JWT filter, tenant context, AOP guard | P0 | 1.5d | [AUTH] [SECURITY] |
| P1-T06 | 1 | OTP generation and verification service | P0 | 1d | [AUTH] |
| P1-T07 | 1 | JWT builder — all 9 required claims | P0 | 1d | [AUTH] |
| P1-T08 | 1 | Notification dispatch adapter — SES + Twilio | P1 | 1d | [INFRA] |
| P1-T09 | 1 | Auth flow — controller + integration tests | P0 | 1.5d | [AUTH] [TEST] |
| P1-T10 | 1 | Next.js auth UI — OTP input, JWT cookie, auth middleware | P0 | 1.5d | [AUTH] |
...
| Task ID | Phase | Name | Priority | Estimate | Tags |
|---|---|---|---|---|---|
| P3-T01 | 3 | Flyway migrations V010–V013 (bookings, outbox, processed_events, audit_log) | P1 | 1d | [MIGRATION] |
| P3-T02 | 3 | Outbox entity and OutboxService (MANDATORY propagation) | P1 | 1d | [KAFKA] |
| P3-T03 | 3 | Debezium connector configuration | P1 | 1d | [KAFKA] [INFRA] |
| P3-T04 | 3 | Kafka topic creation and producer config | P1 | 0.5d | [KAFKA] |
| P3-T05 | 3 | Avro schemas and Schema Registry registration | P1 | 1d | [KAFKA] |
| P3-T06 | 3 | Integrate outbox write into BookingService | P1 | 1d | [KAFKA] |
| P3-T07 | 3 | Notification service scaffold | P1 | 0.5d | [KAFKA] |
| P3-T08 | 3 | NotificationConsumer — idempotency and dispatch | P1 | 1.5d | [KAFKA] |
| P3-T09 | 3 | Audit service scaffold | P1 | 0.5d | [KAFKA] |
| P3-T10 | 3 | AuditConsumer — append-only audit log write | P1 | 1d | [KAFKA] |
| P3-T11 | 3 | Outbox chaos test (Kafka down, DB rollback, Debezium restart) | P1 | 1d | [TEST] [KAFKA] |
| P3-T12 | 3 | Consumer idempotency tests | P1 | 1d | [TEST] [KAFKA] |
...
| Task ID | Phase | Name | Priority | Estimate | Tags |
|---|---|---|---|---|---|
| P4-T01 | 4 | Booking analytics memory — nightly ingestion to `docs/memory/` | P2 | 1d | [ANALYTICS] |
| P4-T02 | 4 | Orchestration workflow templates (`.claude/workflows/`) | P2 | 1d | [ORCHESTRATION] |
| P4-T03 | 4 | AI slot optimization suggestions (Claude API + Redis cache) | P2 | 2d | [SLOT] [ANALYTICS] |
| P4-T04 | 4 | Analytics scheduler — peak booking detection | P2 | 1.5d | [ANALYTICS] |
| P4-T05 | 4 | Auto ADR generation hook for architectural changes | P2 | 0.5d | [ADR] |
...
| Task ID | Phase | Name | Priority | Estimate | Tags |
|---|---|---|---|---|---|
| P5-T01 | 5 | k6 load test — slot availability endpoint (500 RPS, p99<300ms) | P0 | 1d | [TEST] [PERF] |
| P5-T02 | 5 | k6 load test — concurrent booking checkout (500 req/min) | P0 | 1d | [TEST] [PERF] |
| P5-T03 | 5 | Performance tuning — Redis cache warm-up if p99>250ms | P0* | 1d | [PERF] [SLOT] |
| P5-T04 | 5 | Security hardening — full audit sweep (`/security-scan`) | P0 | 1d | [SECURITY] |
| P5-T05 | 5 | Tenant isolation penetration tests | P0 | 1d | [SECURITY] [TEST] |
| P5-T06 | 5 | Production infrastructure — AWS CDK deployment | P0 | 2d | [INFRA] |
| P5-T07 | 5 | CI/CD pipeline — GitHub Actions with all quality gates | P0 | 1d | [INFRA] |
| P5-T08 | 5 | Observability dashboard — Prometheus, Grafana, AlertManager | P1 | 1d | [INFRA] |

*P5-T03 only triggered if P5-T01 breaches 250ms threshold.
